...
class hotspot_model(nn.Module): # hotspot: two transformers
    def __init__(self,
        ...
        self.src_vocab_size1 = 131564+1 # num_pcs + zero padding
        self.src_vocab_size2 = 14   # 9 MOB types + 4 MPF types + 1 zero padding
        self.Trans1 = Transformer(self.src_vocab_size1,self.src_pad_idx,device=device,max_length=self.max_length1,dropout=dropout,feat_size=self.feat_size1, embed_size=512)    # MCL protein Transformer
        self.Trans2 = Transformer(self.src_vocab_size2,self.src_pad_idx,device=device,max_length=self.max_length2,dropout=dropout,feat_size=self.feat_size2, embed_size=32)     # MOB/MPF feature Transformer
