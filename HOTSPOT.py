...
parser.add_argument('--device', help='run the host prediction with gpu or cpu (default gpu)',  type=str, default = 'gpu')
...
def help_info():
    ...
    print("""The usage of HOTSPOT.py:
            ...
            [--device DEV]      Choose gpu or cpu to run the host prediction (default gpu)
